...
export function AppTools() {
  ...
  const products = useProductStore(state => state.products).filter(p => p.category === 'tool');
  ...
  return (
    <section className="py-16 bg-slate-50 min-h-[calc(100vh-80px)]">
      <div className="max-w-7xl mx-auto px-6">
        <h2 className="text-4xl md:text-5xl font-bold mb-12 text-center text-slate-900">App Tools Web Tiện Ích</h2>
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-8">
          {products.map((product, index) => (
            <motion.div 
              ...
              className="bg-white rounded-3xl p-6 border border-slate-200 hover:border-blue-500 hover:shadow-xl hover:shadow-blue-500/10 transition-all flex flex-col h-full relative group"
            >
              {isAdminMode && (
                <button
              ...
              <div className="mt-auto">
                ...
                <button 
                  ...
                  className="w-full py-3 bg-slate-100 hover:bg-blue-600 hover:text-white text-slate-900 rounded-2xl font-semibold flex items-center justify-center gap-2 transition-all"
                >
